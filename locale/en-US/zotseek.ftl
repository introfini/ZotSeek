...
zotseek-search-mode =
    .value = Mode:
zotseek-search-modeHybrid = 🔗 Hybrid (Recommended)
zotseek-search-modeSemantic = 🧠 Semantic Only
zotseek-search-modeKeyword = 🔤 Keyword Only
...
zotseek-search-settings =
    .label = ⚙ Settings
zotseek-search-settingsTooltip = Open ZotSeek preferences
