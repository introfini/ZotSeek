...
zotseek-pref-indexNotesDesc = Indexes the text of notes attached to an item, in addition to the mode above. Turning this on re-indexes every item that has notes.
