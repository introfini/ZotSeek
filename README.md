...
| `zotseek.noteIndexDelay` | `60` | Seconds to wait after a note edit before re-indexing its parent (requires `zotseek.autoIndex`) |
...
| `zotseek.indexNotes` | `false` | Also index the text of child notes attached to an item |
